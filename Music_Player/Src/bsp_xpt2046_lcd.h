...
#define             macXPT2046_EXTI_SOURCE_PIN                      GPIO_Pin	Source4
...
#define             macXPT2046_EXTI_Read()                          HAL_GPIO_ReadPin ( macXPT2046_EXTI_GPIO_PORT, macXPT2046_EXTI_GPIO_PIN )
...
#define             macXPT2046_CS_ENABLE()                          HAL_GPIO_WritePin( macXPT2046_SPI_CS_PORT, macXPT2046_SPI_CS_PIN,GPIO_PIN_SET )    
#define             macXPT2046_CS_DISABLE()                         HAL_GPIO_WritePin ( macXPT2046_SPI_CS_PORT, macXPT2046_SPI_CS_PIN ,GPIO_PIN_RESET )  

#define             macXPT2046_CLK_HIGH()                           HAL_GPIO_WritePin ( macXPT2046_SPI_CLK_PORT, macXPT2046_SPI_CLK_PIN ,GPIO_PIN_SET )    
#define             macXPT2046_CLK_LOW()                            HAL_GPIO_WritePin ( macXPT2046_SPI_CLK_PORT, macXPT2046_SPI_CLK_PIN,GPIO_PIN_RESET  ) 

#define             macXPT2046_MOSI_1()                             HAL_GPIO_WritePin ( macXPT2046_SPI_MOSI_PORT, macXPT2046_SPI_MOSI_PIN,GPIO_PIN_SET  ) 
#define             macXPT2046_MOSI_0()                             HAL_GPIO_WritePin ( macXPT2046_SPI_MOSI_PORT, macXPT2046_SPI_MOSI_PIN ,GPIO_PIN_RESET )

#define             macXPT2046_MISO()                               HAL_GPIO_ReadPin ( macXPT2046_SPI_MISO_PORT, macXPT2046_SPI_MISO_PIN )
