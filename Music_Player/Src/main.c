...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	 ...
	 * file_example_WAV_5MG
	 * file_example_WAV_10MG
	 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_2|GPIO_PIN_0|LCD_RST_Pin, GPIO_PIN_RESET);
