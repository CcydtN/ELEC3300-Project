...
void Check_touchkey(void)
{
	...
	if ( XPT2046_Get_TouchedPoint ( & strDisplayCoordinate, & strXPT2046_TouchPara ) )
	{
		...
		{
			if ( ( strDisplayCoordinate .x >= 62 ) && ( strDisplayCoordinate .x < 78 ) )
			{
				//Last song
			}
			else if ( ( strDisplayCoordinate .x >= 112 ) && ( strDisplayCoordinate .x < 128 ) )
			{
				if(status = pause)
					{
			...
			else if ( ( strDisplayCoordinate .x >= 162 ) && ( strDisplayCoordinate .x < 178 ) )
			{
				//Next song
			}
		}
